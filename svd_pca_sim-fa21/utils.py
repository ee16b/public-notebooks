...
def train_test_split_v2(data, split_ratio=0.7):
    """
    almost same as the last function, but the order is changed
    """
    test_data, train_data = data[:int(len(data)*(1-split_ratio)), :], data[int(len(data)*(1-split_ratio)):, :]
